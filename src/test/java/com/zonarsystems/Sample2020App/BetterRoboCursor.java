...
/**
 * Robolectric implementation of {@link android.database.Cursor}; improved with more overrides.
 */
public class BetterRoboCursor extends BaseCursor {
    public Uri uri;
